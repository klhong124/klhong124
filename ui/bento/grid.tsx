...
const bentoConfig: { [key: number]: string } = {
    ...
    3: "z-10 xl:col-span-1 xl:row-span-3 xl:order-3 md:order-7 md:col-span-3 md:row-span-2 order-8 col-span-3 row-span-1",
    ...
    6: "z-10 xl:col-span-2 xl:row-span-3 xl:order-6 md:order-9 md:col-span-5 md:row-span-2 order-7 col-span-6 row-span-1",
