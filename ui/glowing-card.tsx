...
const GlowingCard = memo(({
    ...
    return (
        <motion.div
            ...
            // The original expanded with `duration: 0.1` — an abrupt jump that
            // read as a glitch. A firm spring settles the card into its larger
            // size instead, and the same spring plays the collapse in reverse.
