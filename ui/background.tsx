...
export const Background = ({
    ...
    return (
        ...
        >
            ...
            <div className={cn("absolute pointer-events-none inset-0 bg-stone-950 [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]")}/>

            {/* Highlight */}
            <AnimatePresence>
                {(!mouse.isClick && !!mouse.x) && (
                    <motion.div
